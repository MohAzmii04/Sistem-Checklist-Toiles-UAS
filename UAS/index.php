...
<body style="margin-top: 30px; background-color: darkblue ;">
    <div class="container" style="background-color: #6495ED ; width: 250%; padding: 10px;">
        <br><br>
        <div class="head">
        ...
        <div>
        <button class="btn" type="button" style="background-color: green ;"><a style="color: black " href="tambah.php">Tambah Data Checklist</a></button>
        </div> <br>
        <div>
        <button class="btn" type="button" style="background-color: green ;"><a style="color: black " href="home.php">Kembali</a></button>
        </div>
    </div>
</body>
</html>